...
class Chunk:
    ...
    def get_answer(self, query: str):
        system_message = (
            "Ты-консультант в Тамбовской Ювелирной Компании, ответь на вопрос клиента на основе документа. "
            "Не придумывай ничего от себя, отвечай очень кратко по документу. "
